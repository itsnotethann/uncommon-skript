...
public interface VerboseAssert {
	 ...
	 */
	String getExpectedMessage(PlatformEvent event);
	 ...
	 */
	String getReceivedMessage(PlatformEvent event);
	
	/**
	 * Helper method to simplify stringify-ing the values of expressions.
	 * Evaluates the expression using {@link Expression#getAll(PlatformEvent)} and stringifies using {@link Classes#toString(Object[], boolean)}.
	 * @param expression The expression to evaluate
	 * @param event The event used for evaluation
	 * @return The string representation of the expression's value.
	 */
	static String getExpressionValue(Expression<?> expression, PlatformEvent event) {
